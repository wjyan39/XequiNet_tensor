"""
QHNet blocks for qc matrice output. 
"""
...
class XMatEmbedding(nn.Module):
    ...
    def __init__(
        ...
        self.rbf_kernel_full = resolve_rbf(rbf_kernel, num_basis, pair_cutoff)
        self.cutoff_fn_full = resolve_cutoff(cutoff_fn, pair_cutoff)
